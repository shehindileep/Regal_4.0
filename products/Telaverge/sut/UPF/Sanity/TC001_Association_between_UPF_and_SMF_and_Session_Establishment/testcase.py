...
Steps:
    ...
    7. Stop capturing packets in SMF node.
    8. Stop SMF node.
    9. Copy pcap file from SMF. 
   10. Validate pcap traces between UPF and SMF nodes.
...
class UPFTest():
    ...
    def manage_script_services(self):
        ...
        self._log.info("Waiting {} seconds for PFCP Association and Session Establishment to be completed between UPF amd SMF nodes.".format(TestCaseConstants.SLEEP_TIME))
    ...
    def validate_pcap(self):
        ...
        self._log.info("PFCP Association and Session Establishment validated successfully.")
        self._log.debug(">")
