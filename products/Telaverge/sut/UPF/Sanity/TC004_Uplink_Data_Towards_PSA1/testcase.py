...
Steps:
    1. Start ULCL and PSA1 nodes.
    2. Capture packets in SMF, I-SMF, DN and gNodeB nodes.
   ...
   16. DN simulator receive the packet and inturn DN will send a packet towards PSA1.
   17. PSA1 will process it and send it towards ULCL.
   18. ULCL simulator will send a packet towards gNodeB.
   19. Stop capturing packets in SMF, I-SMF, DN and gNodeB nodes.
   20. Stop SMF, I-SMF, DN and gNodeB simulators.
   21. Copy pcap file from SMF, I-SMF, DN and gNodeB nodes.
   22. Validate pcap traces between ULCL, PSA1, SMF, I-SMF, DN and gNodeB nodes.
...
class UPFTest():
    ...
    def manage_services(self):
        ...
        self._log.info("ULCL sent uplink packet towards PSA1.")
        self._log.info("Waiting {} seconds for exchange uplink and downlink packets to be completed.".format(TestCaseConstants.SLEEP_TIME_FOR_DN))
        time.sleep(TestCaseConstants.SLEEP_TIME_FOR_DN)
        self._log.info("DN received downlink packet from PSA1.")
        ...
        self._log.info("Stopped capturing tcpdump of uplink and downlink packets on DN node.")
