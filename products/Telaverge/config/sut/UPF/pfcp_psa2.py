...
# PFCP_UP_IP_V4 = "192.168.72.56"
# N3_IP_V4 = "192.168.102.56"
# N9_IP_V4 = "192.168.102.57"
# GNB_IP_V4 = "192.168.110.226"
# # IUPF_IP_V4 = "192.168.101.249"
# # PSA_UPF_IP_V4 = '192.168.104.58'
# ULCL_IP_N9_V4 = '192.168.100.57'
# UE_IP_V4 = "192.168.132.55"

PFCP_CP_IP_V4 = "{{ psa2_traffic_interface_ip }}"
PFCP_UP_IP_V4 = "{{ psa2_n4_ip_v4 }}"
N3_IP_V4 = "{{ psa2_n3_ip_v4 }}"
N9_IP_V4 = "{{ psa2_n9_ip_v4 }}"
GNB_IP_V4 = "{{ gnb_traffic_interface_ip }}"
# IUPF_IP_V4 = "192.168.101.249"
# PSA_UPF_IP_V4 = '192.168.104.58'
ULCL_IP_N9_V4 = "{{ ulcl_n9_ip_v4 }}"
UE_IP_V4 = "{{ psa2_ue_ip_v4 }}"
...
class PfcpSkeleton(object):
    def __init__(self, pfcp_cp_ip,pfcp_up_ip):
        ...
        self.ue_ip = UE_IP_V4
        self.iface = "{{ psa2_interface_name }}"
            ...
            IE_ApplicationID_PFDs(IE_list=[
                ...
                IE_PFDContext(IE_list=[
                    IE_PFDContents(
                        FD=1,
                        flow_length=51,
                        flow="permit in ip from {{ psa2_ue_ip_v4 }} to {{ local_dn_traffic_interface_ip }}"
                    )
                ])
            ]),
            self.nodeId
    ...
    def establish_session_request(self):
        ...
        resp = self.chat(PFCPSessionEstablishmentRequest(IE_list=[
            ...
            IE_CreateTrafficEndpoint(IE_list=[
                ...
                IE_TrafficEndpointId(id=1),
                IE_FTEID(V4=1,TEID=1119,ipv4=N9_IP_V4)
            ]),
            ...
            IE_CreateFAR(IE_list=[
                ...
                IE_ForwardingParameters(IE_list=[
                    ...
                    IE_OuterHeaderCreation(GTPUUDPIPV4=1,TEID=2229,ipv4=ULCL_IP_N9_V4)
                ])
            ]),
            IE_CreatePDR(IE_list=[
                IE_FAR_Id(id=2),
